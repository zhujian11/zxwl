                ...
                <form class="layui-form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="{{ $config->config_title }}">
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="hidden" id="originname" value="{{ $config->config_name }}">
                          <input type="text" name="config_name" lay-verify="configname" autocomplete="off" class="layui-input" value="{{ $config->config_name }}">
                  ...
                  <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" id="content1" value="{{ $config->config_content }}">
            ...
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                      ...
                      url: '{{ route("config.update",$config->config_id) }}',
                      type: 'put',
                      dataType: 'json',
                      data: data.field,
